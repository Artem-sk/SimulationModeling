...
to setup ; initial setup
  ...
  set total-stolen-energy 0
  set total-defeated-foragers 0
  set total-survivors-after-defeats 0
  set total-recognition-attempts 0
  set total-successful-recognitions 0
  set total-poisonous-foragers 0
  set total-survivors-after-poisoning 0
  set murder-count 0
...
to go
  ...
  if-else ticks = 0
    [
      ...
      set avg-stolen-energy 0
    ]
    [
      set average-population total-population / ticks
      set avg-stolen-energy total-stolen-energy / ticks
    ]
  tick
end
...
to move-foragers ; forager procedure
  ...
  [
    ...
    (ifelse
      ...
      visualization = "Speed"
      [
        set color scale-color green get-actual-speed 0 40
      ]
...
"Poisoning" 1.0 0 -7500403 true "" "plot poisoning-death-rate"
...
"Speed" 1.0 0 -13840069 true "" "plot mean [get-actual-speed] of foragers"
...
515
Total Stolen Energy
precision total-stolen-energy 3
17
1
11
...
1385
160
Total Survivors After Poisoning
total-survivors-after-poisoning
17
1
11
